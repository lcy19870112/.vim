...
if has("gui_running") || &t_Co == 256
  ...
  highlight NonText      term=NONE cterm=NONE ctermfg=DarkGrey  ctermbg=NONE gui=NONE guifg=#3a3a3a guibg=NONE
  ...
  highlight StatusLine   term=NONE cterm=NONE ctermfg=DarkGrey  ctermbg=LightGrey  gui=NONE guifg=#ffffff guibg=#3a3a3a
  highlight StatusLineNC term=NONE cterm=NONE ctermfg=DarkGrey   ctermbg=Grey  gui=NONE guifg=#000000 guibg=#3a3a3a
  ...
  highlight VertSplit    term=NONE cterm=NONE ctermfg=243  ctermbg=237  gui=NONE guifg=#c2bfa5 guibg=#7f7f7f
